...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "modules/js/ru/jscalendar/"	// directory for images ... e.g. var imgDir="/img/"

	var gotoString = "Текущий месяц"
	var todayString = "Сегодня"
	var weekString = "Нд."
	var scrollLeftMessage = "Перейти к предыдущему месяцу. Держите кнопку мышки нажатой чтоб прокручивать автоматически."
	var scrollRightMessage = "Перейти на следующий месяц. Держите кнопку мышки нажатой чтоб прокручивать автоматически."
	var selectMonthMessage = "Нажмите чтоб выбрать месяц."
	var selectYearMessage = "Нажмите чтоб выбрать год."
	var selectDateMessage = "Выберите дату [date]." // do not replace [date], it will be replaced by date.
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	class='div-style'><table width="+((showWeekNumber==1)?250:220)+" class='table-style'><tr class='title-background-style' ><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td class='title-style'><B><span id='caption'></span></B></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Закрыть календарь'></a></td></tr></table></td></tr><tr><td class='body-style'><span id='content'></span></td></tr>")
