<?=boxHeader(array('title'=>lang('ResourceOrder.resource.title')))?>
		...
		<td bgcolor="#ffffff">
			<table width="100%">
				<tr>
					<td valign="top">
						<?=getReference('ResourceOrderPaymentStatus','ResourceOrder'.DTR.'ResourceOrderPaymentStatus',$out['DB']['ResourceOrder'][0]['ResourceOrderPaymentStatus'],array('code'=>'Y'))?>
					</td>
					<td valign="top">
						<?=getReference('ResourceOrderStatus','ResourceOrder'.DTR.'ResourceOrderStatus',$out['DB']['ResourceOrder'][0]['ResourceOrderStatus'],array('code'=>'Y'))?>
					</td>
					<td align="center">
			...
			<table width="100%">
				...
				<tr>
					...
					<td valign="center" class="row1" align="left">
						&nbsp;<a href="<?=setting('rooturl')?>admshop/manageResource/ResourceID/<?=$row['ResourceID']?>"><?=getValue($row['ResourceTitle']);?></a>
					</td>
