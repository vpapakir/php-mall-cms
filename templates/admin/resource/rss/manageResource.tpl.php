...
<? $entityID = $out['DB']['Resource'][0]['ResourceID']; $categoryID = input('CategoryID'); ?>
	...
	<tr> 
		<td valign=top bgcolor="#ffffff">
			...
			<?=lang('Resource.links.ResourceType')?>: <b><?=getListValue($out['DB']['ResourceTypes'],$resourceType,array('id'=>'ResourceTypeAlias','value'=>'ResourceTypeName'))?></b>
		</td> 
	</tr>
	<? } else { ?>
	<tr> 
			...
			<td valign="top" bgcolor="#ffffff" class="fieldNames">
					...
					<tr>
						<td valign="top" class="fieldNames">
							...
							<?=lang('Resource.links.ResourceCategories')?>:<br/>
							<?
							...
							<? foreach($out['DB']['Languages']['languageCodes'] as $langID=>$langCode) { ?>
								<?=lang('Resource.links.ResourceTitle')?>: <?=$out['DB']['Languages']['languageNames'][$langID]?>
								<br/>
							...
							<br/>
							<?=lang('Resource.links.ResourceReciprocalLink')?>:<br/>
							<input type="text" name="Resource<?=DTR?>ResourceReciprocalLink" value="<?=$out['DB']['Resource'][0]['ResourceReciprocalLink'];?>" size="90">
							<br>
							<? foreach($out['DB']['Languages']['languageCodes'] as $langID=>$langCode) { ?>
								<?=lang('Resource.links.ResourceIntro')?>: <?=$out['DB']['Languages']['languageNames'][$langID]?>
								<br/>
							...
							<? } ?>
							<br>
							<?=lang('Resource.links.ResourceIcon')?>:<br/>
							...
							<br/>							
							<hr size="1">
							<?=lang('Resource.links.ResourceLanguages')?>:<br/>
							<?
