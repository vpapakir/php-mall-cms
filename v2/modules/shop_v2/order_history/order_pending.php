...
?>
                ...
                <td <?php echo($style_order_history_pending); ?> align="center">
                    <span id="center_text" style="margin-left: 4px;">
                        <SELECT <?php if($data['status_order_history'] == 'onhold') { echo('id="cboOrderPendingStatus'.$data['id_order_history'].'"'); } ?> name="cboOrderPendingStatus<?php echo($data['id_order_history']) ?>" onchange="<?php if($data['status_order_history'] == 'onhold') {echo "submitTnumber('cboOrderPendingStatus".$data['id_order_history']."');"; }?>OnChange('bt_change_order_pending_status<?php echo($data['id_order_history']) ?>');">
