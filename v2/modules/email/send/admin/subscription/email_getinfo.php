...
try
{
    ...
    $prepared_query = 'SELECT * FROM email_mailtext
                       WHERE family_mailtext = "subscription_copy"
    ...
    #replace value
    $subscription_confirm_sendername = str_replace('[#user_fullname]', $subscriptionform_firstname.' '.$subscriptionform_lastname, $subscription_confirm_sendername);
    $subscription_confirm_senderemail = str_replace('[#user_email]', $subscriptionform_email, $subscription_confirm_senderemail);
    $subscription_confirm_subject = str_replace('[#user_fullname]', $subscriptionform_firstname.' '.$subscriptionform_lastname, $subscription_confirm_subject);
    $subscription_confirm_part2 = str_replace('[#date]', $subscription_confirm_date, $subscription_confirm_part2);
    $subscription_confirm_part2 = str_replace('[#time]', $subscription_confirm_time, $subscription_confirm_part2);
}
catch(Exception $e)
{
