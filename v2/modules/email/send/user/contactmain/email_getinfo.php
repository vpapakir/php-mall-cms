...
try
{
    ...
    $prepared_query = 'SELECT * FROM email_mailtext
                       WHERE family_mailtext = "form_contactmain_copy"
    ...
    #replace value       
    $fcontactmain_sendername = str_replace('[#user_name]', $fcontactmain_name, $fcontactmain_sendername);
    $fcontactmain_senderemail = str_replace('[#user_email]', $fcontactmain_email, $fcontactmain_senderemail);
    $fcontactmain_subject = str_replace('[#subject]', $fcontactmain_email_selected_subject, $fcontactmain_subject);
    $fcontactmain_part2 = str_replace('[#date]', $fcontactmain_date, $fcontactmain_part2);
    $fcontactmain_part2 = str_replace('[#time]', $fcontactmain_time, $fcontactmain_part2);
}
catch(Exception $e)
{
