...
<?php
    ...
    ?>
                    <td style="vertical-align: bottom;">                 
                        <a href="<?php echo($href_box_content);?>" style="text-decoration: none; margin: <?php echo($margin_frame); ?>;" class="navtab">&nbsp;<?php echo($title_box_content[$x]); ?>&nbsp;</a>                  
                    </td>
    ...
    ?>
                        <td style="vertical-align: bottom;" width="100%">
                            <a href="<?php echo($href_box_content);?>" style="text-decoration: none;" class="navtab">&nbsp;<?php echo($title_box_content[$x]); ?>&nbsp;</a>                                             
                        </td>
                        <td><div style="width: 2px;"></div></td>           
    <?php 
                    }
