<tr>
    <td align="left"><table class="block_main2" width="100%" style="margin-bottom: 4px;">
            ...
            <td align="left" colspan="2" style="vertical-align: top;">
                <span class="font_subtitle"><?php give_translation('kform_visit.subtitle_userinfo', '', $config_showtranslationcode); ?></span>
                <br clear="left"/>
                [<a class="link_main" href="<?php echo($config_customheader.$rewritingF_myaccount_page); ?>"><?php give_translation('kform_visit.link_modify_userinfo', '', $config_showtranslationcode); ?></a>]
            </td>
...
<?php
                ...
                {
                    $kformvisit_user_selected_country = giveCDRvalue($kformvisit_user_country, 'cdrgeo', $main_id_language);
?>
                    <br clear="left"/>
                    <span class="font_main"><?php echo($kformvisit_user_selected_country); ?></span>               
<?php
                }
...
?>
                    <br clear="left"/>
                    <span class="font_main"><?php give_translation('kform_visit.subtitle_landline', '', $config_showtranslationcode); echo(' '.$kformvisit_user_landline); ?></span>               
<?php
                }
...
?>
                    <br clear="left"/>
                    <span class="font_main"><?php give_translation('kform_visit.subtitle_mobile', '', $config_showtranslationcode); echo(' '.$kformvisit_user_mobile); ?></span>               
<?php
                }
...
?>
                    <br clear="left"/>
                    <span class="font_main"><?php give_translation('kform_visit.subtitle_fax', '', $config_showtranslationcode); echo(' '.$kformvisit_user_fax); ?></span>               
<?php
                }
