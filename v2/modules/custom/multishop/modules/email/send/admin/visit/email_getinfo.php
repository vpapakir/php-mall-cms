...
try
{
    ...
    $prepared_query = 'SELECT * FROM email_mailtext
                       WHERE family_mailtext = "kform_visit"
    ...
    #replace value  
    $kformvisit_sendername = str_replace('[#user_name]', $kformvisit_name, $kformvisit_sendername);
    $kformvisit_senderemail = str_replace('[#user_email]', $kformvisit_user_email, $kformvisit_senderemail);
    ...
    $kformvisit_part2 = str_replace('[#date]', $kformvisit_date, $kformvisit_part2);
    $kformvisit_part2 = str_replace('[#time]', $kformvisit_time, $kformvisit_part2);
}
catch(Exception $e)
{
