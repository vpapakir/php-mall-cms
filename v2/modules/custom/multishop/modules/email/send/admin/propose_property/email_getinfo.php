...
try
{
    ...
    $prepared_query = 'SELECT * FROM email_mailtext
                       WHERE family_mailtext = "kform_proposep_copy"
    ...
    $fproposep_part1 = str_replace('[#user_name]', $fproposep_name, $fproposep_part1);
    $fproposep_part1 = str_replace('[#url_site]', $config_customheader, $fproposep_part1);
    $fproposep_signature = str_replace('[#date]', $fproposep_date, $fproposep_signature);
    $fproposep_signature = str_replace('[#time]', $fproposep_time, $fproposep_signature);
}
catch(Exception $e)
{
