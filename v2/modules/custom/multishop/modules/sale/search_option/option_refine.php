...
<?php
            ...
            {
                include('modules/custom/multishop/modules/sale/search_option/refine/refine_offer.php');
?>
                <tr>
...
<?php
            ...
            {
                include('modules/custom/multishop/modules/sale/search_option/refine/refine_price.php');
?>
                <tr>
                    <td colspan="2"><div style="height: 4px;"></div></td>
                </tr>    
...
<?php
			...
			while(($data = $query->fetch()) != false)
			{
				if($data['immo_module'] == 1) { // select to include the appropriate module file			
					...
					{
						include('modules/custom/multishop/modules/sale/search_option/refine/refine_surface.php');
?>
                <tr>
                    <td colspan="2"><div style="height: 4px;"></div></td>
                </tr>    
...
<?php
			...
			while(($data = $query->fetch()) != false)
			{
				if($data['immo_module'] == 1) { // select to include the appropriate module file			
					...
					{            
						include('modules/custom/multishop/modules/sale/search_option/refine/refine_sleep.php');
?>
...
<?php
			...
			while(($data = $query->fetch()) != false)
			{
				if($data['immo_module'] == 1) { // select to include the appropriate module file			
					...
					{
						include('modules/custom/multishop/modules/sale/search_option/refine/refine_typeobject.php');
?>            
                <tr>
                    <td colspan="2"><div style="height: 4px;"></div></td>
                </tr>    
...
<?php
						include('modules/custom/multishop/modules/sale/search_option/refine/refine_department.php');  
					}
				}
            }
...
<?php
            ...
            {
                include('modules/custom/multishop/modules/sale/search_option/refine/refine_district.php');
...
<?php
		...
		while(($data = $query->fetch()) != false)
		{
            ...
            if(empty($_SESSION['quicksearch_cdreditor_location_situationQuicksearch']))
            {
                include('modules/custom/multishop/modules/sale/search_option/refine/refine_location.php');                    
?>
                <tr>
                    <td colspan="2"><div style="height: 4px;"></div></td>
                </tr>    
...
<?php
            ...
            {
                include('modules/custom/multishop/modules/sale/search_option/refine/refine_condition.php');                 
            }
