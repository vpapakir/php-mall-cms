...
<?php
        include('modules/custom/multishop/modules/sale/search_result/result_main.php');        
        include('modules/custom/multishop/modules/sale/search_option/option_main.php');
        include('modules/custom/multishop/modules/sale/bt/bt_productsearch.php');
        include('modules/custom/multishop/modules/sale/search_result/priority/result_priority.php');
?>
