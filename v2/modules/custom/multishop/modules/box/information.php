...
<?php
            ...
            {
?>
                <td align="left" title="<?php give_translation('sitemap.legend_reference', $echo, $config_showtranslationcode); echo(': '.$temp_code_box_content[0].' - '); give_translation('sitemap.legend_position', $echo, $config_showtranslationcode); echo(': '.$temp_code_box_content[1]); ?>" width="35%">
...
?>
                <td width="65%" align="left">                    
                    <a class="<?php echo($type_box_content[$x]); ?>" style="margin: <?php echo($result_margin_box_content); ?>;" href="<?php echo($href_box_content);?>"><?php echo($title_box_content[$x]); ?></a>
                </td>
            </tr>
<?php
        }
