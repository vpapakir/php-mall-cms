...
<?php
					...
					while(($data = $query->fetch()) != false)
					{
						if($data['immo_module'] == 1) { // select to include the appropriate module file
							include('modules/custom/'.$data['name_configmodule'].'/modules/box/search/surface.php');
						}
					}
?>
                    <tr>
...
<?php
					...
					{
						if($data['immo_module'] == 1) { // select to include the appropriate module file
							include('modules/custom/'.$data['name_configmodule'].'/modules/box/search/sleep.php');
						}
					}
?>
                    <tr>
...
<?php
					...
					{
						if($data['immo_module'] == 1) { // select to include the appropriate module file
							include('modules/custom/'.$data['name_configmodule'].'/modules/box/search/typeobject.php');
						}
					}
?>
                    <tr>
...
<?php
					...
					{
						if($data['immo_module'] == 1) { // select to include the appropriate module file
							include('modules/custom/'.$data['name_configmodule'].'/modules/box/search/department.php');
						}
					}
?>
                    <tr>
...
<?php
					...
					{
						if($data['immo_module'] == 1) { // select to include the appropriate module file
							include('modules/custom/'.$data['name_configmodule'].'/modules/box/search/location.php');
						}
					}
?>
                    <tr>
...
<?php
					...
					{
						if($data['immo_module'] == 1) { // select to include the appropriate module file
							include('modules/custom/'.$data['name_configmodule'].'/modules/box/search/condition.php');
						}
					}
?>
