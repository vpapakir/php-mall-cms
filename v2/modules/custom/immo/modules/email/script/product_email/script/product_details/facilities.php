    ...
    if($count_totalfacilities > 0)
    {
        $message .= '<tr>
                    ...
                    <tr>    
                         <td  class="font_subtitle" align="left" width="'.$custom_1column_width.'" style="vertical-align: top;" colspan="2">
                            '.give_translation('displayvalueimmo.facilities_product_immo', 'false', $config_showtranslationcode).'
                         </td>
                     </tr>
        ...
        for($i = 0, $count = count($customgetinfo_facilitiesorder_situation); $i < $count; $i++) 
        {
                    ...
                    else
                    {
                        $message .= '<tr>
                                    <td align="left" style="vertical-align: top;">
                                        <span class="font_subtitle">'.$customgetinfo_currentkmkey.'&nbsp;km'.'</span>
                                    </td>
                                    <td align="left">
                                        <span class="font_main">';                      
                    }
            ...
            if($customgetinfo_detailsfacilitiesorder_situation[2] != 0)
            {
                ...
                {
                    $message .= $details_facilities.'&nbsp;('.$customgetinfo_detailsfacilitiesorder_situation[1].')'.$customgetinfo_comma;
                }
                else
                {
                    $message .= $details_facilities.$customgetinfo_comma;
                }
            }
