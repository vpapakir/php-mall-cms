...
?>                    
                ...
                <td width="100%" align="center">
                    <span>
                        <?php give_translation('immo.block_title_main_kproduct', $echo, $config_showtranslationcode); ?>
                    </span>
                </td>
                <td align="left"></td>
            </table>
...
?>                
            ...
            <tr>
                <td>
                    <span class="font_subtitle">Number Product</span>
                </td>
                <td>
...
?>
            ...
            <tr>
                <td>
                    <span class="font_subtitle">Status Product</span>
                </td>
                <td>
...
?>
            ...
            <tr>
                <td>
                    <span class="font_subtitle">Code Product L2</span>
                </td>
                <td>
...
?>
            ...
            <tr>
                <td>
                    <span class="font_subtitle">Code Product L3</span>
                </td>
                <td>
                    <input type="text" name="code_product_L3" value="<?php if(!empty($_SESSION['code_product_L3'])){ echo($_SESSION['code_product_L3']); } ?>"/>
<?php
                    if(!empty($_SESSION['msg_Kprodimmo_general_txtKprodimmoReferenceGeneral']))
                    {
?>
...
?>
            ...
            <tr>
                <td>
                    <span class="font_subtitle">Code Product L4</span>
                </td>
                <td>
...
?>
			...
			<tr>
                <td>
                    <span class="font_subtitle">Code Product L5</span>
                </td>
                <td>
                    <input type="text" name="code_product_L5" value="<?php if(!empty($_SESSION['code_product_L5'])){ echo($_SESSION['code_product_L5']); } ?>"/>
<?php
                    if(!empty($_SESSION['msg_Kprodimmo_general_txtKprodimmoReferenceGeneral']))
                    {
?>
...
?>
			...
			<tr>
                <td>
                    <span class="font_subtitle">Priority Product</span>
                </td>
                <td>
                    <input type="text" name="priority_product" value="<?php if(!empty($_SESSION['priority_product'])){ echo($_SESSION['priority_product']); } ?>"/>
<?php
                    if(!empty($_SESSION['msg_Kprodimmo_general_txtKprodimmoReferenceGeneral']))
                    {
?>
