function requestGEOEDITRegionGetinfo()
{
    var xhr = getXMLHttpRequest();
    var resulttag = document.getElementsByName('SearchCDRgeoRegionResultListID');
    ...
    xhr.open("POST", $COOBOX_BASE_URL."modules/cdr/cdrgeo/region/region_ajaxlist_getinfo.php", true);
    ...
    xhr.send("SearchCDRgeoRegionValue="+chosenoption+
