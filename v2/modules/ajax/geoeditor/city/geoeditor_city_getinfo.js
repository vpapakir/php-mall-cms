function requestGEOEDITCityGetinfo()
{
    var xhr = getXMLHttpRequest();
    var resulttag = document.getElementsByName('SearchCDRgeoCityResultListID');
    ...
    xhr.open("POST", $COOBOX_BASE_URL."modules/cdr/cdrgeo/city/city_ajaxlist_getinfo.php", true);
    ...
    xhr.send("SearchCDRgeoCityValue="+chosenoption+
