function requestGEOEDITDistrictGetinfo()
{
    var xhr = getXMLHttpRequest();
    var resulttag = document.getElementsByName('SearchCDRgeoDistrictResultListID');
    ...
    xhr.open("POST", $COOBOX_BASE_URL."modules/cdr/cdrgeo/district/district_ajaxlist_getinfo.php", true);
    ...
    xhr.send("SearchCDRgeoDistrictValue="+chosenoption+
