function requestGEOEDITCountryGetinfo()
{
    var xhr = getXMLHttpRequest();
    var resulttag = document.getElementsByName('SearchCDRgeoCountryResultListID');
    ...
    xhr.open("POST", $COOBOX_BASE_URL."modules/cdr/cdrgeo/country/country_ajaxlist_getinfo.php", true);
    ...
    xhr.send("SearchCDRgeoCountryValue="+chosenoption+
