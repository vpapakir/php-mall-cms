...
<?php 
                if(!empty($_SESSION['msg_currency_upload_activated']))
                { 
                    echo(check_session_input($_SESSION['msg_currency_upload_activated'])); 
                } 
?>
                </div>
            </td>
                            ...
                            <td align="left" width="<?php echo($right_column_width); ?>"><table width="100%">
                                <tr>
                                    ...
                                    <td align="left" class="font_main">
                                        <input style="width: 100%;" type="text" name="txtActNameImageCurrency" value="<?php echo($data['name_image']); ?>"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="font_main">
                                    ...
                                    <td align="left" class="font_main">
                                        <input style="width: 100%;" type="text" name="txtActAltImageCurrency" value="<?php echo($data['alt_image']); ?>"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="font_main">
                                    ...
                                    <td align="left" class="font_main">
                                        <input style="width: 100%;" type="text" name="txtActTitleImageCurrency" value="<?php echo($data['title_image']); ?>"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="font_main">
                                        Répétition
                                    <td align="left" class="font_main">
                                        <select name="cboActRepeatImageCurrency">
