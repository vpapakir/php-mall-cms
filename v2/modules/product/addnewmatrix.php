...
if(isset($_POST['matrix_status']) && isset($_POST['matrix_name_L1'])) {
	...
	$prepared_query = "INSERT INTO matrix VALUES ('".rand()."','$status_matrix',";
	...
	if(isset($_GET['matrix_status'])) {
		$status_matrix = $_GET['matrix_status'];
		$result = -1;
		$prepared_query = 'INSERT INTO matrix (status_matrix) VALUES (:status_matrix)';	
