...
$prepared_query = 'SELECT * FROM language WHERE status_language=1 WHERE status_language=1';
...
if( isset($_POST['groupsForProductType']) ) {

	$prepared_query = "INSERT INTO product_type VALUES (NULL,'".$_POST['cooshopStatusEdit']."',".rand().",";
	...
	foreach ($_POST['groupsForProductType'] as $groups)
	{
