...
?>                            
                        ...
                        <td align="right" width="100%">
                            <input style="width: 70px;" type="text" name="txtCaptchaFormContactMain"/>
                            <input style="display: none;" hidden="hidden" type="text" name="txtCaptchaHiddenFormContactMain" value="<?php echo($_SESSION['current_captcha_code']); ?>"/>
                            &nbsp;
<?php
                            if(!empty($_SESSION['msg_form_contactmain_txtCaptchaFormContactMain']))
                            {
?>
                                <br clear="left"/>
                                <div class="font_error1" style="text-align: center;"><?php echo($_SESSION['msg_form_contactmain_txtCaptchaFormContactMain']); ?></div>
<?php
                            }
?>                            
                        </td>
        ...
        <tr>
            <td colspan="2"><table width="100%" style="">
                <tr>        
                    <td align="center">
                        <input type="submit" name="bt_send_contactmain" value="<?php give_translation('main.bt_send', '', $config_showtranslationcode); ?>"/>
                    </td>
                </tr> 
            </table></td>
        </tr>
