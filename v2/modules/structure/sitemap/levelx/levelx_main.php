...
?>
        <tr>
            <td align="left">
                <span class="font_subtitle"><?php give_translation('sitemap.subtitle_name_element', '', $config_showtranslationcode); echo(' - '); give_translation($main_activatedcodelang[$i], '', $config_showtranslationcode); ?></span>
            </td>
            <td align="left">
