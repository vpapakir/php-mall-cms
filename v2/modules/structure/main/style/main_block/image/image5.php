<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_image5_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectimage5Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_image5) && $block_image5 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
