<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_msgerror2_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelecterror2Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_error2) && $block_error2 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
