<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_pagingnorm3_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left" width="<?php echo($right_column_width); ?>">
        <select name="cboSelectpagingnorm3Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_pagingnorm3) && $block_pagingnorm3 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
...
<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_paginghov3_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left" width="<?php echo($right_column_width); ?>">
        <select name="cboSelectpaginghov3Block">
            <option value="select"><?php give_translation('main.dd_select', '', $config_showtranslationcode); ?></option>
<?php
        for($i = 0, $count = count($id_block); $i < $count; $i++)
        {
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    style="border: <?php echo($border_block[$i].'px solid'); ?>;
                            ...
                            background-image: url('<?php echo($image_block[$i]); ?>');"
                    class="<?php echo($font_block[$i]); ?>"
                    <?php if(!empty($block_paginghov3) && $block_paginghov3 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
                ><?php echo($name_block[$i]); ?></option>
<?php            
        }
?>
...
<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_pagingact3_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectpagingact3Block">
            <option value="select"><?php give_translation('main.dd_select', '', $config_showtranslationcode); ?></option>
<?php
        for($i = 0, $count = count($id_block); $i < $count; $i++)
        {
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    style="border: <?php echo($border_block[$i].'px solid'); ?>;
                            ...
                            background-image: url('<?php echo($image_block[$i]); ?>');"
                    class="<?php echo($font_block[$i]); ?>"
                    <?php if(!empty($block_pagingact3) && $block_pagingact3 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
                ><?php echo($name_block[$i]); ?></option>
<?php            
        }
?>
