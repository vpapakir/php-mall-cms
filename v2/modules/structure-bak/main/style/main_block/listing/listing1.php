<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_listing1_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left" width="<?php echo($right_column_width); ?>">
        <select name="cboSelectlisting1Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_listing1) && $block_listing1 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
