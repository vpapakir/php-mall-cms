<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_msgerror3_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelecterror3Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_error3) && $block_error3 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
