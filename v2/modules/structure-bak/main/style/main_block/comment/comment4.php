<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_comment4_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectcomment4Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_comment4) && $block_comment4 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
