<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_title5_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelecttitle5Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_title5) && $block_title5 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
