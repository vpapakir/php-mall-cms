<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_image4_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectimage4Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_image4) && $block_image4 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
