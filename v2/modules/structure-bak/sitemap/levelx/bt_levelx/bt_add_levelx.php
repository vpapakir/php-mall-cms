            ...
            try
            {
                ...
                $prepared_query = 'INSERT INTO hierarchy_box_content
                                   (reference_hierarchy_box_content, code_hierarchy_box_content, status_hierarchy_box_content, id_hierarchy_box, 
                                    ...
                                    userrights_hierarchy_box_content, family_hierarchy_box_content, ';
                ...
                include('modules/structure/sitemap/levelx/bt_levelx/upload/levelx_upload.php');
            }
            catch(Exception $e)
            {
