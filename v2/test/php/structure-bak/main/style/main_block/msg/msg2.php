<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_msg2_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectmsg2Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_msg2) && $block_msg2 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
