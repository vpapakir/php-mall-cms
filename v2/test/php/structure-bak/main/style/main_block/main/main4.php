<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_main4_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectmain4Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_main4) && $block_main4 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
