<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_msginfo2_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectinfo2Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_info2) && $block_info2 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
