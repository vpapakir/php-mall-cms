<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_comment5_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectcomment5Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_comment5) && $block_comment5 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
