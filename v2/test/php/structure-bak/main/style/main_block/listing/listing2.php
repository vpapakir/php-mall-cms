<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_listing2_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectlisting2Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_listing2) && $block_listing2 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
