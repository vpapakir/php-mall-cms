<tr>
    <td align="left" class="font_subtitle">
        <?php give_translation('edit_structure.subtitle_image3_block', '', $config_showtranslationcode); ?>
    </td>
    <td align="left">
        <select name="cboSelectimage3Block">
...
?>
            <option value="<?php echo($id_block[$i]); ?>"
                    ...
                    <?php if(!empty($block_image3) && $block_image3 == $id_block[$i]){ echo('selected="selected"'); }else{ echo(null); } ?>
