...
?>
<option style="background-color: lightgray; color: black;" disabled="true"><?php give_translation('edit_structure.template_style_button', '', $config_showtranslationcode) ?></option>
<?php            
