...
if((checkrights($main_rights_log, $userrights_hierarchybox[$i])) === true)
{
    ...
    ?>
                       ...
                       <td <?php if(!empty($tablebg_box)){ ?>style="background-color: <?php echo($tablebg_box); ?>;"<?php } ?>><table id="block_box_content<?php echo($id_box_structure); ?>" cellpadding="<?php echo($padding_blockcontent); ?>">
    <?php
                   }
                }
    ?>        
