<?=boxHeader(array('title'=>'ManageLanguages.core.title'))?>
	...
	<input type="hidden" name="SID" value="manageLanguages" />
	...
	<? $formName='manageLanguages';?>
	<form name="manageLanguages" method="post" enctype="multipart/form-data">
		<input type="hidden" name="SID" value="manageLanguages" />
		...
		<tr> 
			<td valign="top" bgcolor="#ffffff" width="100%">
				<table cellpadding="2" cellspacing="0" width="100%" border="0">
					<tr>
						<td align="left">
							<span class="subtitle"><?=lang('Language.LanguageCode')?>: </span>
						</td>
						<td align="left">
					...
					<tr>
						<td valign="top" class="fieldNames" align="left">
							<span class="subtitle"><?=lang('Language.LanguageName')?>: </span>
					...
					<tr>
						<td align="left">
							<span class="subtitle"><?=lang('Language.LanguageTranslationType')?>: </span>
						</td>
						<td align="left">
					...
					<tr>
						<td align="center" bgcolor="#efefef" colspan="2">
							...
							<? } else { ?>
							<input type="submit" value="<?=lang("-save")?>">&nbsp;&nbsp;<input type="button" value="<?=lang("-delete")?>" onClick="document.manageLanguages.actionMode.value='delete';confirmDelete('manageLanguages', '<?=lang("-deleteconfirmation")?>');">
							<? } ?>					
						</td>
					</tr>
				</table>
