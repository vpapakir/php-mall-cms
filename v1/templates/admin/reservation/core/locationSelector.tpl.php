...
<SCRIPT language=JavaScript>
	...
	window.location = '<?=setting('url')?><?=input('SID')?>/redirectMode/1/locStr/'+rs1+'/formName/<?=input('formName')?>/fieldName/<?=input('fieldName')?>/windowMode/popup';
}
</SCRIPT>
<? } ?>
	...
	<form method="post" name="<?=$formName?>">
		...
		<input type="hidden" name="redirectMode" value="<?=input('redirectMode')?>" />
