<? //boxHeader(array('title'=>lang('Messages.core.tip')))?>
<table cellspacing="0" cellpadding="0" align="left" width="100%" height="100%">		
	<tr>
		<td align="center" valign="middle">
			<table cellspacing="0" cellpadding="0" align="left">	
				<tr>
					...
					<? if($out['DB']['SupportMessage']!="0" && !empty($out['DB']['SupportMessage'])){?>
						<td valign="middle">	
		...
		<td align="center">
			<table align="center">
				<tr>
					<td>&nbsp;</td>
					<td align="center" valign="middle">
						<? /*$rss = getFormated(setting('SttausFrameMessagesLink'),'RSS');?>
