...
<table width="994"  border="0" cellspacing="0" cellpadding="0">
 ...
 <!--  <tr>
    <td height="23" align="left" valign="middle" class="icons">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%" valign="middle">
					<? //getBox('core.adminShortcutsMenu');?>
				</td>
				<td width="40%" align="right" valign="middle">
					<? //getBox('core.languageSwitcher');?>&nbsp;		
					<? /*if(user('UserName')) { ?>
						<b><?=lang('-connected')?>: <?=user('UserName')?>&nbsp;</b>
					<? }*/ ?>	
				</td>
			</tr>
		</table>	
  ...
  <tr>
    <td height="23" align="left" valign="middle" class="bottom"><?=getFormated(setting('Copyright'),'HTML')?>&nbsp;&nbsp;<?=getFormated(setting('Version'),'HTML')?>&nbsp;&nbsp;<?=lang('License.core.tip')?>: <?=setting('SystemLicense')?></td>
  </tr>
  <tr>
    <td background="<?=setting('layout')?>images/bg-line.gif"><img src="<?=setting('layout')?>images/bg-line.gif" width="1" height="2"></td>
  </tr>
