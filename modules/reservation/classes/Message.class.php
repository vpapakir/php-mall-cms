...
class MessageClassReservation
{
    ...
    *
    */	
	function MessageClassReservation()
	{
		global $CORE;
    ...
    */
	function getMessages($input)
	{
		...
		$SERVER->setDebug('MessageClassReservation.getMessages.Start','Start');
		$DS = &$this->_DS;
		$config = $this->_config;
		$user = $this->_user;
		$userID = $user['UserID'];
		...
		//set filters
		//$filter = $DS->getAccessFilter($input,'MessageClassReservation.adminMessage');
...
//echo $query;
		...
		$SERVER->setDebug('MessageClassReservation.getMessages.End','End');
		return $result;
	}	
	...
	function getClientMessages($input)
	{
		//set global variables
		$SERVER = &$this->_controller;
		$SERVER->setDebug('MessageClassReservation.getLastAdminMessages.Start','Start');
		$DS = &$this->_DS;
		$config = $this->_config;
		$user = $this->_user;
		$userID = $user['UserID'];
...
//echo $query;
		$result = $DS->query($query,$mode); 
		$SERVER->setDebug('MessageClassReservation.getLastAdminMessages.End','End');
		return $result;
	}	
...
//echo $query;
    ...
    */	
	function getMessage($input)
	{
		//set global variables
		$SERVER = &$this->_controller;
		$SERVER->setDebug('MessageClassReservation.getMessage.Start','Start');
		$DS = &$this->_DS;
		$config = $this->_config;
		$user = $this->_user;
		$userID = $user['UserID'];
		...
		{
			//$SERVER->setMessage('MessageClassReservation.getMessage.err.NoMessageID');
		}
		$SERVER->setDebug('MessageClassReservation.getMessage.End','End');		
		return $result;		
	}
    /**
    * sets entities
    ...
    */	
	function setMessage($input)
	{
		//set global variables
		$SERVER = &$this->_controller;
		$SERVER->setDebug('MessageClassReservation.setMessage.Start','Start');
		$DS = &$this->_DS;	
		$config = $this->_config;
		$user = $this->_user;		
		$userID = $user['UserID'];
			...
			else
			{
				...
				if($isActive=='Y')	
				{
					...
					if($input['actionMode']=='attach')
					{
						...
						$SERVER->setMessage('MessageClassReservation.setMessage.msg.DataSaved');
					}
				...
				{
					$SERVER->setMessage('MessageClassReservation.setMessage.err.NoReceiverFound');
				}
			}
		}
		else
		{
			$SERVER->setMessage('MessageClassReservation.setMessage.err.NoSenderName');
		}
		$SERVER->setDebug('MessageClassReservation.setMessage.End','End');		
		return $result;		
	}
...
//print_r($emailIN);
    ...
    */	
	function deleteMessage($input)
	{
		//set global variables
		$SERVER = &$this->_controller;
		$SERVER->setDebug('MessageClassReservation.deleteMessage.Start','Start');
		$DS = &$this->_DS;	
		$config = $this->_config;
		$user = $this->_user;		
		$user = $this->_user;
		...
		$SERVER->setMessage('MessageClassReservation.deleteMessage.msg.DataDeleted');
		$SERVER->setDebug('MessageClassReservation.deleteMessage.End','End');		
		return $result;		
	}	
    ...
    */	
	...
	function getClients($input)
	{
		//set global variables
		$SERVER = &$this->_controller;
		$SERVER->setDebug('MessageClassReservation.getClients.Start','Start');
		$DS = &$this->_DS;
		$config = $this->_config;
		$user = $this->_user;
		$UserID = $user['UserID'];
		...
		$SERVER->setDebug('MessageClassReservation.getClients.End','End');
		return $result;
	}	

	
} // end of MessageClassReservation
?>